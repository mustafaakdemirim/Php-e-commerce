							...
							<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4">
								...
								<div class="col">
									<div class="card rounded-0 product-card">
										...
										<a href="<?= $ürün->ıd ?>">
											<img src="<?= $ürün->urun_resim ?>" class="card-img-top" alt="...">
										</a>
										<div class="card-body">
											<div class="product-info">
												...
												<a href="javascript:;">
													<h6 class="product-name mb-2"><?= $ürün->urun_adi ?></h6>
												</a>
												<div class="d-flex align-items-center">
												...
												<div class="product-action mt-2">
													<div class="d-grid gap-2">
														<?php if (isset($_SESSION['user'])) {?>
															<a id="<?= $ürün->ıd ?>" onclick="addtocard(this.id)" class="btn btn-dark btn-ecomm">	<i class='bx bxs-cart-add'></i>Add to Cart</a><?php } ?>
														<?php if (!(isset($_SESSION['user']))) { ?>
															<a href="authentication-signin.php" class="btn btn-dark btn-ecomm">	<i class='bx bxs-cart-add'></i>Add to Cart</a><?php } ?>
														<a class="btn btn-light btn-ecomm" data-bs-toggle="modal" data-bs-target="#QuickViewProduct"><i class='bx bx-zoom-in'></i>Quick View</a>
													</div>
												</div>
											</div>
										</div>
...
//       	event.preventDefault();
		...
		function addtocard($tiklanan){
			...
			//alert($tiklanan);
			<?php // session_start(); 
				//$_SESSION['ürün'] = array("ıd"=>$ürün->ıd,"urun_adi"=>$ürün->urun_adi,"urun_stok"=>$ürün->stok,"urun_resim"=>$ürün->urun_resim);
				//$ürün_ıd = $_SESSION['ürün']["ıd"];
			?>
			//$.post('islem.php',{ıd:ıd});
