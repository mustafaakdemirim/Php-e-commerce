...
//session_start();
	...
	//$sorgu = $db->prepare("SELECT * FROM users WHERE email = {$_SESSION['user']['email']}");
	//$sorgu->execute();
	//$row = $sorgu->fetchAll(PDO::FETCH_OBJ);
	//echo $_SESSION['email'];
											...
											<div class="card-body">
												<form method="POST" class="row g-3">
													<div class="col-md-6">
														...
														<input name="first_name" type="text" class="form-control" value="<?php echo $_SESSION['user']["first_name"]?>">
													</div>
													<div class="col-md-6">
														<label class="form-label">Last Name</label>
														<input name="last_name" type="text" class="form-control" value="<?php echo $_SESSION['user']["last_name"]?>">
													</div>
													<!--<div class="col-12">
													...
													<div class="col-12">
														...
														<input name="email" type="text" class="form-control" value="<?php echo $_SESSION['user']["email"]?>">
													</div>
													<div class="col-12">
														<label class="form-label">Current Password</label>
														<input name="password" type="password" class="form-control" value="<?php echo $_SESSION['user']["password"]?>">
													</div>
													<div class="col-12">
													...
													<div class="col-12">
														<button name="güncelle" type="submit" class="btn btn-dark btn-ecomm">Save Changes</button>
													</div>
												</form>
											</div>
										</div>
