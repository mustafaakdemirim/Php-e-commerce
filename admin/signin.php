												...
												<div class="main-signup-header">
													...
													<form method="POST">
														<div class="form-group">
															<label>Email</label> <input name="eposta" class="form-control" placeholder="Enter your email" type="text">
														</div>
														<div class="form-group">
															<label>Password</label> <input name="sifre" class="form-control" placeholder="Enter your password" type="password">
														</div><button name="giris" type="submit" class="btn btn-main-primary btn-block">Sign In</button>
