...
require_once('islem.php');
    ...
    $ürün_detay_sorgu->execute([$_GET['ıd']]);
...
<body>	<b class="screen-overlay"></b>
									...
									<?php 
											if (isset($_SESSION['user'])) {?>
												...
												<?php if(!(isset($_SESSION['user']))) {?>
													<li class="nav-item"><a href="authentication-signin.php" class="nav-link cart-link"><i class="bx bx-user"></i></a>
												</li>
												<?php } ?>
										...
										<li class="nav-item dropdown dropdown-large">
											<?php if (isset($_SESSION['user'])) { ?>
												<a id="<?php  echo $_SESSION['user']["ıd"] ?>" onclick="getcart(this.id)" class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative cart-link" data-bs-toggle="dropdown">	<span class="alert-count"><?php
											$user_ıd = $_SESSION['user']["ıd"];
											$cart_ = $db->prepare('SELECT * FROM cart WHERE user_ıd = ?');
											$cart_->execute([$user_ıd]);
											$count = $cart_->rowCount();
											echo $count; ?></span>
												<i class='bx bx-shopping-bag'></i>
											</a>
											<div id="product" class="dropdown-menu dropdown-menu-end">
											<?php } ?>
											<?php if (!(isset($_SESSION['user']))) { ?>
												<a href="authentication-signin.php" class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative cart-link" data-bs-toggle="dropdown">		<span class="alert-count">0</span>
													<i class='bx bx-shopping-bag'></i>
												</a>
				...
				<section class="py-3 border-bottom border-top d-none d-md-flex bg-light">
					<div class="container">
						<div class="page-breadcrumb d-flex align-items-center">
							<h3 class="breadcrumb-title pe-3"><?php echo $ürün_detay['urun_adi']?></h3>
							<div class="ms-auto">
								...
								<div class="row g-0">
									<div class="col-12 col-lg-5">
										<div class="image-zoom-section">
											<div class="product-gallery owl-carousel owl-theme border mb-3 p-3" data-slider-id="1">
												<div class="item">
													<img src="<?php echo $ürün_detay['urun_resim']?>" class="img-fluid" alt="">
												</div>
												<div class="item">
											...
											<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
												<button class="owl-thumb-item">
													<img src="<?php echo $ürün_detay['urun_resim']?>" class="" alt="">
												</button>
												<button class="owl-thumb-item">
									...
									<div class="col-12 col-lg-7">
										<div class="product-info-section p-3">
											<h3 class="mt-3 mt-lg-0 mb-0"><?php echo $ürün_detay['urun_adi'] ?></h3>
											...
											<div class="d-flex align-items-center mt-3 gap-2">
												...
												<h4 class="mb-0"><?php echo $ürün_detay['urun_stok'] ?></h4>
												<span id="span"></span>
											</div>
											<div class="mt-3">
												<h6>Discription :</h6>
											...
											<dl class="row mt-3">	<dt class="col-sm-3">Product id</dt>
												<dd  class="col-sm-9"><?php echo $ürün_detay['ıd']?></dd>	<dt class="col-sm-3">Delivery</dt>
											...
											<?php if (isset($_SESSION['user'])) {?>
															<a id="<?php //echo $ürün_detay['ıd'] ?>" onclick="addtocard(<?php echo $ürün_detay['ıd'] ?>)" class="btn btn-white btn-ecomm">	<i class='bx bxs-cart-add'></i>Add to Cart</a><?php } ?>
														<?php if (!(isset($_SESSION['user']))) { ?>
															<a href="authentication-signin.php" class="btn btn-white btn-ecomm">	<i class='bx bxs-cart-add'></i>Add to Cart</a><?php } ?>
	...
	function productcancel($id,$user_id){
		$.ajax({
			url: "islem.php",
			method: "POST",
			data: {$id,$user_id},
